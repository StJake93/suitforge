...
export function legUndersuit(
  { ref, kit }: BuildContext,
  role: 'secondary' | 'primary' = 'secondary',
): ItemPart[] {
  const thigh = () =>
    kit.group(
      kit.at(kit.mesh(kit.sphere(ref.thighR * 1.1, 14), role), 0, 0, 0),
      kit.at(
        kit.mesh(kit.cyl(ref.thighR * 1.06, ref.thighR * 0.98, ref.thighLen, 12), role),
        0,
        ref.thighLen * 0.5,
        0,
      ),
  ...
  const shin = () =>
    kit.group(
      kit.at(
        kit.mesh(kit.cyl(ref.shinR * 1.1, ref.shinR * 0.98, ref.shinLen, 12), role),
        0,
        ref.shinLen * 0.5,
        0,
      ),
  ...
  const shorts = kit.at(
    kit.mesh(
      kit.rbox(ref.pelvisHalfW * 2 * 1.06, ref.hu * 0.66, ref.pelvisDepth * 1.08, ref.pelvisDepth * 0.2),
      role,
    ),
    0,
    -ref.hu * 0.02,
  ...
  },
  {
    ...
    build: (ctx) => {
      ...
      const thighPlate = () =>
        kit.at(
          kit.mesh(
            kit.plate(ref.thighR * 2.0, ref.thighLen * 0.62, ref.thighR * 0.5, ref.thighR * 0.3),
            'primary',
          ),
          0,
          ref.thighLen * 0.42,
      ...
      const kneeCap = () =>
        kit.at(
          kit.mesh(kit.sphere(ref.shinR * 1.25, 10), 'primary'),
          0,
          ref.shinLen * 0.04,
          ref.shinR * 0.55,
        );
      const shinPlate = () =>
        kit.at(
          kit.mesh(
            kit.plate(ref.shinR * 1.9, ref.shinLen * 0.6, ref.shinR * 0.45, ref.shinR * 0.3),
            'secondary',
          ),
          0,
          ref.shinLen * 0.5,
      ...
      const stripe = () =>
        kit.at(
          kit.mesh(kit.box(ref.thighR * 0.25, ref.thighLen * 0.5, ref.thighR * 0.1), 'accent'),
          ref.thighR * 0.95,
          ref.thighLen * 0.42,
          ref.thighR * 0.45,
        );
