...
export const vanguard: ItemDefinition[] = [
  {
    ...
    build: ({ ref, kit }) => {
      ...
      const lens = kit.at(kit.mesh(kit.rbox(r * 1.5, r * 0.36, r * 0.12, r * 0.06), 'glass'), 0, 0.12 * r, r * 0.98);
      const frame = kit.at(kit.mesh(kit.rbox(r * 1.62, r * 0.1, r * 0.16, r * 0.03), 'dark'), 0, 0.34 * r, r * 0.96);
