...
Limb sockets point +Y *down* the limb (origin at the proximal joint); head/neck/chest/pelvis/foot sockets are upright (+Y up, +Z forward). `back` has +Z pointing backward.
